...
public class EasyBlockRotatedPillar extends EasyBlock {
	public static final PropertyEnum<EnumFacing.Axis> AXIS = PropertyEnum.<EnumFacing.Axis>create("axis",
			EnumFacing.Axis.class);

	protected EasyBlockRotatedPillar(String name, Material materialIn) {
		super(name, materialIn, materialIn.getMaterialMapColor());
	}

	protected EasyBlockRotatedPillar(String name, Material materialIn, MapColor color) {
