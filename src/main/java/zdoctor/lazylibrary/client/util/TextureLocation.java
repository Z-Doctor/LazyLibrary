...
/**
 * This class helps path textures from common paths. All names are set to lower
 * regardless of case.
 */
public abstract class TextureLocation extends ResourceLocation {
	...
	private TextureLocation(String resourcePathIn) {
		this(Loader.instance().activeModContainer().getModId(), resourcePathIn);
	}

	private TextureLocation(String resourceDomainIn, String resourcePathIn) {
	...
	public static class EntityTextureLocation extends TextureLocation {
		public EntityTextureLocation(String resourcePathIn) {
			super(updateEntityPath(resourcePathIn));
		}
